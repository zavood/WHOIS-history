...
Agent Technical Contacts:
   First Name:    Belbone
   Last Name:     Administrators
   Company Name:  Belgacom NV/SA
   Language:      en
   Street:        Rue Carlistraat 2
   Location:      1140 EVERE
   Country:       BE
   Phone:         +32.80025250
   Fax:           +32.27248498
   Email:         dns-masters@belbone.be

Agent:
   Name:      Belgacom sa/nv
   Website:   http://www.belgacom.be/dns

Nameservers:
   ns.belbone.be (195.13.1.13)
   ns2.belbone.be (194.78.48.13)
   ns3.belbone.be (195.13.2.13)
