...
Domain:      blogt
Status:      REGISTERED
Registered:  Wed Jan 26 2005

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Tech Contact ---- NOT OWNER OF DOMAIN NAME
   Company Name:  Openminds bvba
   Language:      nl
   Street:        Zwijnaardsesteenweg 169/103
   Location:      BE 9000 Gent
   Country:       BE
   Phone:         +32.92258291
   Fax:           +32.92244657
   Email:         dom-admin@openminds.be

Agent:
   Name:      Openminds Bvba
   Website:   www.openminds.be
