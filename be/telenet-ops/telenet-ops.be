...
Domain:      telenet-ops
Status:      REGISTERED
Registered:  Tue Jan 13 1998

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Technical Internet
   Company Name:  Telenet NV
   Language:      nl
   Street:        Liersesteenweg 4
   Location:      2800 Mechelen
   Country:       BE
   Phone:         +32.15333000
   Fax:           +32.15333999
   Email:         dnsberequest@staff.telenet.be
...
Nameservers:
   ns.telenet-ops.be (195.130.132.17)
   ns2.telenet-ops.be (213.224.126.242)
