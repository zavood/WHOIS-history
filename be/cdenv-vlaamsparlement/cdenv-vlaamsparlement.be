...
%-
% WHOIS cdenv-vlaamsparlement
Domain:      cdenv-vlaamsparlement
Status:      REGISTERED
Registered:  Tue Feb  4 2003

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Verhaegen Frank
   Company Name:  BYS - By Your Site -
   Language:      nl
   Street:        Stokkellaan 132
   Location:      West-Vlaanderen 8400 Oostende
   Country:       BE
   Phone:         +32.59435844
   Fax:           +32.59435884
   Email:         dns@bys.be
