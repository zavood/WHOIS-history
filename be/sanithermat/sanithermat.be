...
Agent Technical Contacts:
   Last Name:     Eddy DIEU
   Company Name:  ZEUS COMPUTER SPRL
   Language:      fr
   Street:        Parc Scientique Initialis
   Street2:       26 Boulevard Initialis
   Location:      Hainaut 7000 MONS
   Country:       BE
   Phone:         +32.65321005
   Fax:           +32.65321006
   Email:         eddy.dieu@zeuscomputer.be

Agent:
   Name:      Zeus Computer Sprl
   Website:   www.zeuscomputer.be
