...
Domain:      lescorsaires
Status:      REGISTERED
Registered:  Thu Apr 10 2003

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   First Name:    Jens-Ingo
   Last Name:     Brodesser
   Company Name:  Moving Art Studio ASBL
   Company Name2: ALL2ALL.ORG, The Independent Network
   Language:      en
   Street:        51 rue de l'Instruction
   Location:      1070 Bruxelles
   Country:       BE
   Phone:         +32.24118410
   Fax:           +32.25385581
   Email:         registry@all2all.org

Agent:
   Name:      Moving Art Studio ASBL
   Website:   http://www.all2all.be/

Nameservers:
   dns1.lescorsaires.be (79.99.202.241)
   dns3.all2all.org
