...
Agent Technical Contacts:
   ...
   Last Name:     Noms de Domaine
   Company Name:  AMEN
   Language:      fr
   Street:        12-14, rond-point des Champs-Elysees
...
Agent:
   Name:      AMEN.FR L Agence des MEdias Numeriques
   Website:   AMEN.FR

Nameservers:
   ns2.hi-media-publishing.com
   ns1.hi-media-publishing.com
