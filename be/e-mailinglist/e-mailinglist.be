...
Agent Technical Contacts:
   Last Name:     Vincent Goemaere
   Company Name:  Stardekk BVBA
   Language:      nl
   Street:        Altenastraat 2
   Location:      W-VL 8310 Brugge
   Country:       BE
   Phone:         +32.50383868
   Fax:           +32.50350502
   Email:         vincent@stardekk.be

Agent:
   Name:      Stardekk BVBA
   Website:   www.stardekk.be

Nameservers:
   ns5.european-server.com
   ns6.european-server.com
