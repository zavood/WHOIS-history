...
Domain:      idnet
Status:      REGISTERED
Registered:  Fri Aug 22 1997

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     IDcreation nv
   Company Name:  IDcreation nv
   Language:      nl
   Street:        Bissegemstraat 33
   Location:      8560 Gullegem
   Country:       BE
   Phone:         +32.56261000
   Fax:           +32.56261001
   Email:         info@idcreation.be

Agent:
   Name:      Idcreation
   Website:   www.idcreation.be

Nameservers:
   idnetserver.idnet.be (217.76.224.2)
   cobalt.siemen.be
