...
Domain:      eurodb
Status:      REGISTERED
Registered:  Tue Oct 15 1996

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Hostmaster Tech DNS
   Company Name:  Verizon Belgium Luxembourg NV/SA
   Language:      en
   Street:        Culliganlaan 2/E
   Location:      1831 Diegem
   Country:       BE
   Phone:         +32.24008300
   Fax:           +32.24008400
   Email:         support-dns@verizonbusiness.com

Agent:
   Name:      Verizon Belgium Luxembourg NV/SA
   Website:   www.verizonbusiness.com/be

Nameservers:
   dns01.eurodb.be (212.190.81.61)
   dns02.coface.be
   auth00.ns.be.uu.net
   auth50.ns.be.uu.net
