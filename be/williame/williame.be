...
Domain:      williame
Status:      REGISTERED
Registered:  Sat Nov 24 2001

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     NetBulk Support
   Company Name:  NetBulk NV
   Language:      nl
   Street:        Antwerpsesteenweg 377
   Location:      Oost-Vlaanderen 9040 Gent
   Country:       BE
   Phone:         +32.90005555
   Fax:           +32.92187978
   Email:         support@netbulk.com

Agent:
   Name:      Netbulk NV
   Website:   www.netbulk.com
