...
Domain:      camer
Status:      REGISTERED
Registered:  Fri Jul  1 2005

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Stephane Bouvard
   Company Name:  MyOwn sprl
   Company Name2: Technical Support
   Language:      fr
   Street:        Rue Francois Lesnino, 58 bte 19
   Location:      1020 Bruxelles
   Country:       BE
   Phone:         +32.28887140
   Fax:           +32.28887269
   Email:         support@myown.be

Agent:
   Name:      MyOwn sprl
   Website:   www.myown.eu
