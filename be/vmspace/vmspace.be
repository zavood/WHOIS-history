...
Domain:      vmspace
Status:      REGISTERED
Registered:  Tue Jan 13 2009

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Yourdomainnameregistrar.com
   Company Name:  Yourdomainnameregistrar.com
   Language:      nl
   Street:        Postbus 7
   Location:      NB 3200AA Spijkenisse
   Country:       NL
   Phone:         +31.9001234663
   Fax:           +31.181750315
   Email:         info@yourdomainnameregistrar.com

Agent:
   Name:      YourDomainNameRegistrar.com
   Website:   www.YourDomainNameRegistrar.com

Nameservers:
   ns1.vmspace.be (85.17.239.15)
   ns2.vmspace.be (85.17.239.61)
