...
Domain:      asp
Status:      REGISTERED
Registered:  Tue Oct  3 1995

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Sales asp.be
   Company Name:  ASP.be
   Language:      en
   Street:        Humaniteitslaan - Blvd de l'humanite 224
   Location:      1190 Brussels
   Country:       BE
   Phone:         +32.23334000
   Fax:           +32.23334060
   Email:         support@asp.be

   First Name:    Support
   Last Name:     Division
   Company Name:  ASP.be
   Language:      en
   Street:        Neerstalsesteenweg 40
   Location:      1190 Brussels
   Country:       BE
   Phone:         +32.23703939
   Fax:           +32.23765850
...
Nameservers:
   ns3.asp.be (80.65.128.124)
   ns4.asp.be (80.65.129.70)
