...
Domain:      ago
Status:      REGISTERED
Registered:  Thu Mar 21 1996

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     MES Hostmaster
   Company Name:  Mobistar Enterprise Services nv/sa
   Language:      nl
   Street:        Bourgetlaan 3
   Location:      1140 Brussel
   Country:       BE
   Phone:         +32.26103000
   Fax:           +32.26103010
   Email:         dnsadmin@mail.mobistar.be

Agent:
   Name:      Mobistar Enterprise Services nv/sa
   Website:   business.mobistar.be
