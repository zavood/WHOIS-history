...
Domain:      priorweb
Status:      REGISTERED
Registered:  Wed Jan  1 2003

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Domain Administration
   Company Name:  PriorWeb
   Language:      nl
   Street:        Cockerillkaai 12
   Location:      2000 ANTWERPEN
   Country:       BE
   Phone:         +32.32954117
   Fax:           +32.32954217
   Email:         helpdesk@priorweb.be

Agent:
   Name:      PriorWeb
   Website:   www.priorweb.be

Nameservers:
   ns1.priorweb.be (62.182.60.69)
   ns2.priorweb.be (62.182.60.71)
   ns3.priorweb.be (85.17.177.151)
