...
Agent Technical Contacts:
   Last Name:     Jan Dries
   Company Name:  D-Cube Resource
   Language:      nl
   Street:        Mispelaarstraat 44
   Location:      3600 GENK
   Country:       BE
   Phone:         +32.89690000
   Fax:           +32.89690001
   Email:         techcontact@dcube-resource.be

Agent:
   Name:      D-Cube Resource
   Website:   www.dcube-resource.be

Nameservers:
   ns2.seoweb.be (62.182.62.215)
   ns1.seoweb.be (62.182.62.215)
