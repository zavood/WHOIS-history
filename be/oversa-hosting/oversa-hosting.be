...
%-
% WHOIS oversa-hosting
Domain:      oversa-hosting
Status:      REGISTERED
...
Agent Technical Contacts:
   First Name:    Sander
   Last Name:     Cruiming
   Company Name:  XXL Webhosting
   Language:      nl
   Street:        Tjonger 28
   Location:      9204 AS Drachten
   Country:       NL
   Phone:         +31.512842182
   Fax:           +31.512842182
   Email:         support@xxlwebhosting.nl

Agent:
   Name:      AutoDNS
   Website:   www.autodns.nl

Nameservers:
   ns1.oversa-hosting.be (81.4.88.10)
   ns1.oversa-hosting.be
   ns2.oversa-hosting.be (81.4.96.30)
   ns2.oversa-hosting.be
