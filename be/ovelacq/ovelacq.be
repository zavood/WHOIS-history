...
Domain:      ovelacq
Status:      REGISTERED
Registered:  Fri May  1 1998

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     DNS Support
   Company Name:  easynet Belgium nv/sa
   Language:      en
   Street:        Leonardo Da Vincilaan 9
   Location:      1935 Zaventem
   Country:       BE
   Phone:         +32.24023700
   Fax:           +32.24023701
   Email:         support-dns@be.easynet.net
...
Agent:
   Name:      easynet Belgium nv/sa
   Website:   www.be.easynet.net
