...
Domain:      mariakefas
Status:      REGISTERED
Registered:  Tue Jan 25 2005

Licensee:
   Not shown, please visit www.dns.be for webbased whois.

Agent Technical Contacts:
   Last Name:     Jan De Volder
   Company Name:  Volo Media Ltd
   Language:      en
   Street:        Tas-Sellum Residence
   Street2:       612, Tunnara Promenade
   Location:      MLH Mellieha
   Country:       MT
   Phone:         +0.0
   Fax:           +0.0
   Email:         contact@volo-media.com

Agent:
   Name:      Volo Media Ltd.
   Website:   www.volo.com.mt
