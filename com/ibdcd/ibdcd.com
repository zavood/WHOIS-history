...
for detailed information.
   ...
   Domain Name: IBDCD.COM
   Registrar: MARKMONITOR INC.
   Whois Server: whois.markmonitor.com
   Referral URL: http://www.markmonitor.com
   Name Server: DNS.INVESTORS.COM
   Name Server: NS1.WILLIAMONEIL.COM
...
Registrant:
        ...
        US
        licensing@investors.com +1.3104486956 Fax: +1.3104486520
    ...
    Record last updated on..: 2011-08-15.

    Domain servers in listed order:

    ns1.williamoneil.com
    dns.investors.com
