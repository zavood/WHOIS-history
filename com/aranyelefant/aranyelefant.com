...
for detailed information.
   ...
   Domain Name: ARANYELEFANT.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS2.DEBIANSZERVER.HU
   Name Server: SERV6.DEBIANSZERVER.HU
   Status: ok
...
Registrars.
Registration Service Provided By: ANNUS TAMAS E.V.
Contact: +036.06302624551
...
Domain servers in listed order:
    ns2.debianszerver.hu
    serv6.debianszerver.hu
