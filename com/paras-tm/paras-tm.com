...
for detailed information.
   ...
   Domain Name: PARAS-TM.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.YELLOW.MYSITEHOSTED.COM
   Name Server: NS2.YELLOW.MYSITEHOSTED.COM
   Status: ok
...
Registrant:
    Ecomsys Web solution
    Mr Hitesh Pathak        (info@ecomsysindia.net)
    7/A Gopalbaug Society,
    B/h Bhairavnath Bus-stop, Bhairavnath Road,
    Maninagar,
    Ahmedabad,
    Gujarat,380008
    IN
...
Domain servers in listed order:
    ns1.yellow.mysitehosted.com
    ns2.yellow.mysitehosted.com
