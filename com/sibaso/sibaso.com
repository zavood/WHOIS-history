...
for detailed information.
   ...
   Domain Name: SIBASO.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: IKANASIN.WARUNGPOJOK.NET
   Name Server: SAYURASEM.WARUNGPOJOK.NET
   Status: ok
...
Registrant:
    None
    Carolus Darmawan        (cbdarmawan@hotmail.com)
    Jl. Belimbing V-B17 no. 63, Taman Pagelaran
    Bogor
    Jawa Barat,16610
    ID
    Tel. +62.08128356536
...
Domain servers in listed order:
    ikanasin.warungpojok.net
    sayurasem.warungpojok.net
