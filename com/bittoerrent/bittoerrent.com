...
for detailed information.
   ...
   Domain Name: BITTOERRENT.COM
   Registrar: 3597245 CANADA INC. DBA NIC-NAME INTERNET SERVICE CORP.
   Whois Server: whois.nic-name.ca
   Referral URL: http://www.nic-name.ca
...
Registrars.
The results below are provided by nic-name.ca.
(whois.nic-name.ca)

By using nic-name.ca's WHOIS database, you confirm that you understand
the following, and you agree to be bound by the terms of usage and
limitations of warranty contained herein.

Although the data contained in nic-name.ca's WHOIS database is believed
by the company to be reliable, it is provided &quot;as is&quot;. nic-name.ca
...
information that may be included in the database. nic-name.ca's sole
...
written permission of nic-name.ca. By submitting a query to nic-name.ca,
...
Domain: bittoerrent.com

  Date Registered: 07/20/11
    Date Modified: 07/26/11
  ...
  Technical Contact
        ...
        Registrar: nic-name.ca


Register your domain now at www.nic-name.ca
