...
for detailed information.
   ...
   Domain Name: TALADTIDDAO.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS13.HOSTINGLOTUS.NET
   Name Server: NS14.HOSTINGLOTUS.NET
   Status: ok
...
Registrant:
    None
    natpaphat phetcharus        (dao_bdcreate@hotmail.com)
    49/4 Ramkhamhaeng road
    Hua Mark
    Bangkapi
    Bangkok,10240
    TH
...
Domain servers in listed order:
    ns13.hostinglotus.net
    ns14.hostinglotus.net
