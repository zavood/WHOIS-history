...
for detailed information.
   ...
   Domain Name: AMEXNETWORK.COM
   Registrar: CSC CORPORATE DOMAINS, INC.
   Whois Server: whois.corporatedomains.com
   Referral URL: http://www.cscglobal.com
   Name Server: GW.AEXP.COM
   Name Server: GW2.AEXP.COM
   Name Server: GW3.AEXP.COM
   Name Server: GW4.AEXP.COM
   Name Server: GW5.AEXP.COM
