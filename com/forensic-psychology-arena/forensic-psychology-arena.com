...
for detailed information.
   ...
   Domain Name: FORENSIC-PSYCHOLOGY-ARENA.COM
   Registrar: SAFENAMES LTD
   Whois Server: whois.safenames.net
   Referral URL: http://www.safenames.net
   Name Server: NS1.TANDF.CO.UK
   Name Server: NS2.TANDF.CO.UK
...
Domain Name: FORENSIC-PSYCHOLOGY-ARENA.COM
  ...
  [REGISTRANT]
    ...
    Contact Name:      Leonardo Tarafa
    Address Line 1:    6000 Broken Sound Parkway
    Address Line 2:    NW Suite 300
    City / Town:       Boca Raton
    State / Province:
    Zip / Postcode:    33487
    Country:           US
    Telephone:         +1.5613616017
    Fax:
    Email:             leonardo.tarafa@informausa.com

  [ADMIN]
    Organisation Name: Informa Group plc
    Contact Name:      Neil Tubb
    Address Line 1:    30-32 Mortimer Street
    Address Line 2:
    City / Town:       London
    State / Province:  London
    Zip / Postcode:    W1W 7RE
    Country:           UK
    Telephone:         +44.2070175000
    Fax:
    Email:             Ray.Schlosbon@taylorandfrancis.com
