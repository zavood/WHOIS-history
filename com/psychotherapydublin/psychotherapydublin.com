...
for detailed information.
   ...
   Domain Name: PSYCHOTHERAPYDUBLIN.COM
...
The Registry database contains ONLY .COM, .NET and .ORG domains.
     ...
     Registrant Name: SHELLYFLANAGAN.COM
     Contact: ShellyFlanagan.com
     Registrant Address: 23 Belmont Avenue
     Registrant City: Dublin 4
