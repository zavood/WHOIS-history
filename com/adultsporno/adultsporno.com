...
for detailed information.
   ...
   Domain Name: ADULTSPORNO.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: DIRMYDOMENS.EARTH.ORDERBOX-DNS.COM
   Name Server: DIRMYDOMENS.MARS.ORDERBOX-DNS.COM
   Name Server: DIRMYDOMENS.MERCURY.ORDERBOX-DNS.COM
   Name Server: DIRMYDOMENS.VENUS.ORDERBOX-DNS.COM
...
Domain servers in listed order:
    dirmydomens.earth.orderbox-dns.com
    dirmydomens.mars.orderbox-dns.com
    dirmydomens.mercury.orderbox-dns.com
    dirmydomens.venus.orderbox-dns.com
