...
for detailed information.
   ...
   Domain Name: JHPLATINUM.COM
   Registrar: UK2 GROUP LTD.
   Whois Server: whois.hostingservicesinc.net
   Referral URL: http://www.resell.biz
   Name Server: DNS1.JHPLATINUM.COM
   Name Server: DNS2.JHPLATINUM.COM
   Name Server: DNS3.JHPLATINUM.COM
   Name Server: DNS4.JHPLATINUM.COM
...
Registrars.
Registration Service Provided By: JOGJAHOST WEB HOSTING &amp; DOMAIN REGISTER
Contact: +62.8812742458

Domain Name: JHPLATINUM.COM

Registrant:
    Eko Danang Waskito
    Eko Danang Waskito        (me@ekodanangwaskito.com)
    JL Monjali Blunyah Gede No91,
    Sinduadi Mlati
    Sleman
    Yogyakarta,55284
    ID
