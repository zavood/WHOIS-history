...
Registrant:
    D Popli
    Akshay Popli        (meher@micropixsolutions.co.in)
    Readymoney Bldg
    Battery St, Apollo Bunder
    Mumbai
    Maharashtra,400039
    IN
    Tel. +091.66607791
...
Administrative Contact:
    D Popli
    Mehernosh M. Baliwalla        (meher@micropixsolutions.co.in)
    73A Vikas Finlay Towers
    Parel Tank Road
    Parel-East
    Mumbai
    Maharashtra,400033
