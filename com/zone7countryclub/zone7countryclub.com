...
for detailed information.
   ...
   Domain Name: ZONE7COUNTRYCLUB.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: AS5.INJAN-NETWORK.COM
   Name Server: AS6.INJAN-NETWORK.COM
...
Registrant:
    ZONE7COUNTRYCLUB
    DEACHOCHAI KONGSUREEPORN        (pome_1544@sanook.com)
    40/31 suchar 1 tavewattana rd.
    nongkkhangplue
    bangkok
    nongkheam,10160
    TH
...
Domain servers in listed order:
    as5.injan-network.com
    as6.injan-network.com
