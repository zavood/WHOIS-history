...
for detailed information.
   ...
   Domain Name: HOTELBALCI.COM
   Registrar: EVOPLUS LTD
   Whois Server: whois.evonames.com
   Referral URL: http://www.evonames.com
   Name Server: NS1.LINKIN-PARK.BIZ
   Name Server: NS2.LINKIN-PARK.BIZ
   Status: ok
...
Registrant:
    Proxy Private Registration         hotelbalci.com@whoisprotectservice.net
