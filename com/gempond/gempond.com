...
for detailed information.
   ...
   Domain Name: GEMPOND.COM
   Registrar: UK2 GROUP LTD.
   Whois Server: whois.hostingservicesinc.net
   Referral URL: http://www.resell.biz
   Name Server: NS1.DOMAIN-DNS.COM
   Name Server: NS2.DOMAIN-DNS.COM
   Name Server: NS3.DOMAIN-DNS.COM
   Status: ok
...
Registrant:
    Not Applicable
    null        (novalidemail@stargate.com)
    Not Available
    Not Available
    Not Available,null
    US
...
Administrative Contact:
    Not Applicable
    If you really want to know me this is not the way        (opera@home.se)
    Not Available
    Not Available
    Not Available,null
    US
