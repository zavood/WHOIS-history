...
for detailed information.
   ...
   Domain Name: RIMANSI.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS5.WEB.COM.PH
   Name Server: NS6.WEB.COM.PH
   Status: ok
...
Registrars.
Registration Service Provided By: ARTWEB PHIL.
Contact: +632.6568478
Website: http://www.artwebph.com/

Domain Name: RIMANSI.COM

Registrant:
    ArtWeb Services, Inc.
    Arthur A. Galenzoga        (domains@artwebph.com)
    Unit 528 Building A, One Oasis Condominium,
    Ortigas Avenue Extension, Rosario,
    Pasig City
    Not Applicable,1609
    PH
    Tel. +63.9186323946
