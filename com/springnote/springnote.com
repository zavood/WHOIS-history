...
for detailed information.
   ...
   Domain Name: SPRINGNOTE.COM
   Registrar: GABIA, INC.
   Whois Server: whois.gabia.com
   Referral URL: http://www.gabia.com
   Name Server: NS.NCSOFT.NET
   Name Server: NS2.NCSOFT.NET
...
Registrant : Ncsoft CO.,LTD
	...
	Administrative, Technical, Billing Contact:
		Kyeong Phill Kang	domain@ncsoft.net
		OksanB/D 10F, 157-33, Samseong-dong, Gangnam-gu, Seoul
		(Tel) 02-6201-8426	(fax)

	Record created on 	FEBRUARY  16, 2007
	Record expires on 	FEBRUARY  16, 2012
	Record last updated on 	FEBRUARY  01, 2011
