...
for detailed information.
   ...
   Domain Name: MULTIPLEK.COM
   Registrar: DATTATEC.COM DE IRAZOQUI VERONICA PALMIRA
   Whois Server: whois.dattatec.com
   Referral URL: http://www.dattatec.com
   Name Server: NS1.DATTATEC.COM.MX
   Name Server: NS1.HOSTMAR.COM.MX
   Name Server: NS1.TRAXHOST.COM
   Name Server: NS2.DATTATEC.COM.MX
   Name Server: NS2.HOSTMAR.COM.MX
   Status: ok
...
Registrant conatct:
   Name:    Jesus Antonio Martinez Covarrubias
   Company: Jesus Antonio Martinez Covarrubias
   Email:   jsfixcc@gmail.com
   Address: Carretera San Pedro Ahuacatlan KM1
            MX - San Juan del Rio ( zip: 76810 )
   Phone  : 52 - 4272712317
