...
for detailed information.
   ...
   Domain Name: IPADSHOUSE.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS0.CP.IF.UA
   Name Server: NS2.CP.IF.UA
...
Registrars.
Registration Service Provided By: SERVICE ONLINE LLC - DOMAIN REGISTRATION SYSTEM - DRS.UA
...
Registrant:
    none
    Mykytyuk Andriy        (mykytadrey@gmail.com)
    57 2nd ave apt 44
    0
    New York
    null,10003
...
Technical Contact:
    Service Online LLC
    Service Online LLC        (support@nic.ua)
    PO BOX 147
    0
    KYIV
    KYIV,04050
