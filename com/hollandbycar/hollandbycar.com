...
for detailed information.
   ...
   Domain Name: HOLLANDBYCAR.COM
   Registrar: UK2 GROUP LTD.
   Whois Server: whois.hostingservicesinc.net
   Referral URL: http://www.resell.biz
   Name Server: NS1.PROLOCATION.NET
   Name Server: NS2.PROLOCATION.NET
   Name Server: NS3.PROLOCATION.NET
   Status: ok
...
Registrant:
    Prolocation B.V.
    Prolo Domain Registry        (domain-registry@prolocation.net)
    Populierlaan 3B
    Rijswijk
    Zuid-Holland,2282 KX
    NL
    Tel. +31.703260425
    Fax. +31.703260426
