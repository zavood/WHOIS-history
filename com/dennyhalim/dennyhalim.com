...
for detailed information.
   ...
   Domain Name: DENNYHALIM.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: EARTH.HOST-JET.COM
   Name Server: MARS.HOST-JET.COM
   Name Server: MERCURY.HOST-JET.COM
   Name Server: VENUS.HOST-JET.COM
...
Registrars.
Registration Service Provided By: POLARISNETWORK.COM
Contact: +62.2170762052
Website: http://www.host-jet.com

Domain Name: DENNYHALIM.COM

Registrant:
    Polaris
    Denny        (mail2dny@gmail.com)
    Harcomas
    Jakarta
    Jakarta,10730
    ID
...
Domain servers in listed order:
    earth.host-jet.com
    mars.host-jet.com
    mercury.host-jet.com
    venus.host-jet.com


Administrative Contact:
    PolarisNetwork.com
    Denny Halim        (brandprotection@mypolaris.com)
    HarcoMAS Mangga Dua
    3rd floor, no 37
