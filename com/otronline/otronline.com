...
for detailed information.
   ...
   Domain Name: OTRONLINE.COM
   Registrar: DOTSTER, INC.
   Whois Server: whois.dotster.com
   Referral URL: http://www.dotster.com
   Name Server: NS1.OTRONLINE.COM
   Name Server: NS2.OTRONLINE.COM
   Name Server: NS3.OTRONLINE.COM
   Name Server: NS4.OTRONLINE.COM
   Name Server: NS5.OTRONLINE.COM
   Status: clientDeleteProhibited
   Status: clientTransferProhibited
   Status: clientUpdateProhibited
   Updated Date: 25-aug-2011
   Creation Date: 06-oct-2000
