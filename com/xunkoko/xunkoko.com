...
for detailed information.
   ...
   Domain Name: XUNKOKO.COM
   Registrar: DATTATEC.COM DE IRAZOQUI VERONICA PALMIRA
   Whois Server: whois.dattatec.com
   Referral URL: http://www.dattatec.com
   Name Server: DNS1.POWERHOST.CL
   Name Server: DNS2.POWERHOST.CL
   Name Server: DNS3.POWERHOST.CL
   Name Server: DNS4.POWERHOST.CL
   Status: ok
   Updated Date: 11-oct-2010
   Creation Date: 11-oct-2010
   Expiration Date: 11-oct-2011

&gt;&gt;&gt; Last update of whois database: Sat, 17 Sep 2011 10:33:41 UTC &lt;&lt;&lt;
...
Registrant contact:
   Name:    PowerHost U.S.A
   Company: PowerHost Telecomunicaciones
   Email:   info@powerhost.cl
   Address: Private
            US - Chicago ( zip: 10009 )
   Phone  : 1 - 6562003
