...
for detailed information.
   ...
   Domain Name: CRIMEREPORTS.COM
   Registrar: REBEL.COM CORP.
   Whois Server: whois.rebel.com
   Referral URL: http://www.rebel.com
   Name Server: NS01.PUBLICENGINES.COM
   Name Server: NS02.PUBLICENGINES.COM
   Name Server: NS03.PUBLICENGINES.COM
...
Domain: crimereports.com
  ...
  Date Registered: 01/29/99
    Date Modified: 01/13/10
      Expiry Date: 11/02/17
      	     DNS1: ns01.publicengines.com
      	     DNS2: ns02.publicengines.com

  Registrant

                   Public Engines
                   Domain Admin
                   11781 Lone Peak Parkway #200
                   Draper, UT (US)
                   84020
