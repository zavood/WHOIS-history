...
for detailed information.
   ...
   Name Server: NS-DBLN.VERIZONWIRELESS.COM
   Name Server: NS-ORBG.VERIZONWIRELESS.COM
   Name Server: NS-SCRM.VERIZONWIRELESS.COM
   Name Server: NS-TWBG.VERIZONWIRELESS.COM
