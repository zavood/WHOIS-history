...
for detailed information.
   ...
   Domain Name: SMARTADSERVER.COM
   Registrar: MAILCLUB SAS
   Whois Server: whois.mailclub.net
   Referral URL: http://www.mailclub.fr/
   Name Server: ASIA9.AKAM.NET
   Name Server: EUR6.AKAM.NET
   Name Server: NS1-172.AKAM.NET
   Name Server: NS1-198.AKAM.NET
...
&gt;&gt;&gt; Last update of whois database: Fri, 16 Sep 2011 00:03:29 UTC &lt;&lt;&lt;
...
Registrant:
    auFeminin.com SA
    AUFEMININ, Aufeminin        (infra@aufeminin.com)
...
Technical Contact:
    MAILCLUB S.A.S.
    TINE, Charles        (clientele@mailclub.fr)
...
Billing Contact:
    Mailclub
    Frederic Guillemaut        (clientele@mailclub.fr)
    37 rue Guibal
    Pole Media Belle de Mai
    Marseille
    null,13356
    FR
    Tel. +33.488662222
...
prior written consent from us. The Registrar of record is Mailclub SAS.
