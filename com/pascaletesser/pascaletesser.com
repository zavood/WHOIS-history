...
for detailed information.
   ...
   Domain Name: PASCALETESSER.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.UNISERVER.NL
   Name Server: NS2.UNISERVER.NL
   Name Server: NS3.UNISERVER.NL
   Status: ok
   Updated Date: 26-nov-2010
   Creation Date: 02-dec-2008
   Expiration Date: 02-dec-2011

&gt;&gt;&gt; Last update of whois database: Mon, 19 Sep 2011 12:06:27 UTC &lt;&lt;&lt;
...
Registrars.
Registration Service Provided By: UNISERVER INTERNET BV
Contact: +31.725725646

Domain Name: PASCALETESSER.COM

Registrant:
    B Colourfool Make-up Artist B.V.
    PA  Tesser        (domainadmin@uniserver.nl)
    Wollegras 52
    Purmerend
    ,1441WG
    NL
...
Technical Contact:
    Uniserver Internet
    Uniserver domainadministration        (domainadmin@uniserver.nl)
    Walmolenn 128
    Amsterdam
    NH,1035BR
    NL
