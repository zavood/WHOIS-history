...
for detailed information.
   ...
   Domain Name: BIDONMILWAUKEE.COM
   Registrar: MARKMONITOR INC.
   Whois Server: whois.markmonitor.com
   Referral URL: http://www.markmonitor.com
   Name Server: NS1-CLE.BLUEBRIDGENETWORKS.NET
   Name Server: NS1-COL.BLUEBRIDGENETWORKS.NET
   Name Server: NS2-CLE.BLUEBRIDGENETWORKS.NET
   Name Server: NS2-COL.BLUEBRIDGENETWORKS.NET
...
Registrant:
    ...
    ns1-col.bluebridgenetworks.net
    ns2-cle.bluebridgenetworks.net
    ns1-cle.bluebridgenetworks.net
    ns2-col.bluebridgenetworks.net
