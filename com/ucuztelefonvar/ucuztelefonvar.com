...
for detailed information.
   ...
   Domain Name: UCUZTELEFONVAR.COM
   Registrar: FBS INC.
   Whois Server: whois.isimtescil.net
   Referral URL: http://www.isimtescil.net
   Name Server: NS1.CEVAHIRBILISIM.NET
   Name Server: NS2.CEVAHIRBILISIM.NET
...
Registrant:
    Murat Yagmur CID248599
    Murat Yagmur        (murat.yagmur@stu.adu.edu.tr)
    karsiyaka
    IZMIR
    ,35560
    TR
...
Domain servers in listed order:
    ns1.cevahirbilisim.net
    ns2.cevahirbilisim.net
