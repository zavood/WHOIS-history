...
for detailed information.
   ...
   Domain Name: MENJADI.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS5.MENJADI.COM
   Name Server: NS6.MENJADI.COM
   Name Server: NS7.MENJADI.COM
   Status: ok
...
Registrant:
    WarningNews Services
    Kalpin Erlangga Silaen        (warningnews@yahoo.com)
    Jl. Salman No. 156 RT. 007/03
    Kebon Jeruk
    Jakarta Barat
    Jakarta
    Jakarta,11530
