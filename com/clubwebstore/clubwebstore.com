...
for detailed information.
   ...
   Domain Name: CLUBWEBSTORE.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS.YUHU.BIZ
   Name Server: NS1.WEBSTORE.BG
   Name Server: NS2.WEBSTORE.BG
   Name Server: NS3.CLUBWEBSTORE.COM
   Status: ok
...
Registrars.
Registration Service Provided By: WEBSTORE LTD
Contact: +359.888923463
Website: http://www.webstore.bg

Domain Name: CLUBWEBSTORE.COM

Registrant:
    Webstore LTD
    Milen Mihaylov        (mihaylovm@gmail.com)
    Sediankova livada 27, vh A
    Gabrovo
    Gabrovo,5300
    BG
    Tel. +359.888851145
