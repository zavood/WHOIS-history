...
for detailed information.
   ...
   Domain Name: WINDATAILOR.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.BMOHOSTING.COM
   Name Server: NS2.BMOHOSTING.COM
   Status: ok
...
Registrant:
    Bali Media Online
    Made Arnawa        (made_bulls@hotmail.com)
    Jl. Padma Utara No.10c Legian Kuta
    Denpasar
    Bali,81152
    ID
    Tel. +62.8124675026
