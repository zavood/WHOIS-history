...
for detailed information.
   ...
   Domain Name: MARIOTOMIC.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.MINT-SERVICES.NET
   Name Server: NS2.MINT-SERVICES.NET
   Status: ok
...
Registrant:
    None
    Mario Tomic        (mario@mariotomic.com)
    K. Stankovica 11
    Novi Sad
    Podunavski,21000
    RS
...
Domain servers in listed order:
    ns1.mint-services.net
    ns2.mint-services.net
