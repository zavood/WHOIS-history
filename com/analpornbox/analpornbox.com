...
for detailed information.
   ...
   Domain Name: ANALPORNBOX.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: REGNAMEBIZ.EARTH.ORDERBOX-DNS.COM
   Name Server: REGNAMEBIZ.MARS.ORDERBOX-DNS.COM
   Name Server: REGNAMEBIZ.MERCURY.ORDERBOX-DNS.COM
   Name Server: REGNAMEBIZ.VENUS.ORDERBOX-DNS.COM
...
Domain servers in listed order:
    regnamebiz.earth.orderbox-dns.com
    regnamebiz.mars.orderbox-dns.com
    regnamebiz.mercury.orderbox-dns.com
    regnamebiz.venus.orderbox-dns.com
