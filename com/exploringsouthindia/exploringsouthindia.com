...
for detailed information.
   ...
   Domain Name: EXPLORINGSOUTHINDIA.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.BRIDGE2SERVER.COM
   Name Server: NS2.BRIDGE2SERVER.COM
...
Registrant:
    Self
    Utkarsh Verma        (utkarshverma01@gmail.com)
    F1, Sri Sai Nivas
    Sarjapur Junction
    Bangalore
    Karnataka,560102
...
Domain servers in listed order:
    ns1.bridge2server.com
    ns2.bridge2server.com
