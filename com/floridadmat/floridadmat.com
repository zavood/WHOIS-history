...
for detailed information.
   ...
   Domain Name: FLORIDADMAT.COM
   Registrar: UK2 GROUP LTD.
   Whois Server: whois.hostingservicesinc.net
   Referral URL: http://www.resell.biz
   Name Server: RUTLD.EARTH.ORDERBOX-DNS.COM
   Name Server: RUTLD.MARS.ORDERBOX-DNS.COM
   Name Server: RUTLD.MERCURY.ORDERBOX-DNS.COM
   Name Server: RUTLD.VENUS.ORDERBOX-DNS.COM
   Status: clientTransferProhibited
   Updated Date: 07-dec-2010
   Creation Date: 02-nov-2010
   Expiration Date: 02-nov-2011

&gt;&gt;&gt; Last update of whois database: Sat, 10 Sep 2011 08:45:56 UTC &lt;&lt;&lt;
...
Domain servers in listed order:
    rutld.earth.orderbox-dns.com
    rutld.mars.orderbox-dns.com
    rutld.mercury.orderbox-dns.com
    rutld.venus.orderbox-dns.com
