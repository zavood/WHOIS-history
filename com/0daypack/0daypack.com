...
for detailed information.
   ...
   Domain Name: 0DAYPACK.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS3.CANHOST.US
   Name Server: NS4.CANHOST.US
...
Registration Service Provided By: CanHost DataServices, Inc
Contact: info@canhost.us

Send all abuse notification at : abuse@canhost.us

=-=-=-=-=-=
GET BEST PRICES ON DOMAINS ONLY AT CANHOST.US
=-=-=-=-=-=

Visit: http://www.canhost.us
...
Registrant Contact:
    CanHost DataServices, Inc
    Domain Admin        (canhostdataservices@ymail.com)
    CanHost IDC
    Lucknow
    UP,226016
    IN
