...
for detailed information.
   ...
   Domain Name: DOBUSINESSINFRANCE.COM
   Registrar: WILD WEST DOMAINS, INC.
   Whois Server: whois.wildwestdomains.com
   Referral URL: http://www.wildwestdomains.com
   Name Server: NS1.GREENWEBSERVERS.NET
   Name Server: NS2.GREENWEBSERVERS.NET
...
Registrant:
   ...
   Domain servers in listed order:
      NS1.GREENWEBSERVERS.NET
      NS2.GREENWEBSERVERS.NET
   ...
   ****************************************************
   ...
   http://who.securepaynet.net/whoischeck.aspx?domain=DOBUSINESSINFRANCE.COM&amp;prog_id=domaindo
