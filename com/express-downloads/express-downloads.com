...
for detailed information.
   ...
   Domain Name: EXPRESS-DOWNLOADS.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: VEKSUPER.EARTH.OBOX-DNS.COM
   Name Server: VEKSUPER.MARS.OBOX-DNS.COM
   Name Server: VEKSUPER.MERCURY.OBOX-DNS.COM
   Name Server: VEKSUPER.VENUS.OBOX-DNS.COM
...
Registrant:
    N/A
    Michael D. Huddleston        (Huddleston22@gmail.com)
    4285 Custer Street
    Warren
    Pennsylvania,16365
    US
...
Domain servers in listed order:
    veksuper.earth.obox-dns.com
    veksuper.mars.obox-dns.com
    veksuper.mercury.obox-dns.com
    veksuper.venus.obox-dns.com
