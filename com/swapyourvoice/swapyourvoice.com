...
for detailed information.
   ...
   Domain Name: SWAPYOURVOICE.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.HOSTINGFARMS.COM
   Name Server: NS2.HOSTINGFARMS.COM
   Status: ok
...
Registrant:
    TMM Online Research Private Limited
    Arun Bagariah        (swapyourvoice@ymail.com)
    156, BTM Layout
    II Stage
    Bengaluru
    Karnataka,852364
