...
for detailed information.
   ...
   Domain Name: SANOOKFISHING.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS7.HOSTINGLOTUS.NET
   Name Server: NS8.HOSTINGLOTUS.NET
   Status: ok
...
Registrant:
    -
    Surat Peangprasitporn        (tonfishingman@yahoo.com)
    168/4 Chaiyapreak Rd.
    Klongchukpra
    Talingchun
    Bangkok
    ,10170
...
Domain servers in listed order:
    ns7.hostinglotus.net
    ns8.hostinglotus.net
