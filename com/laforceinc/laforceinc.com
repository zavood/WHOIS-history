...
for detailed information.
   ...
   Name Server: NS1.NETNET.NET
   Name Server: NS2.NETNET.NET
...
Registrars.
Registration Service Provided By: NETNET INC.
Contact: +1.9206176700

Domain Name: LAFORCEINC.COM

Registrant:
    La Force Hardware &amp; Mfg. Co.
    Jeff Bukouricz        (laforce@netnet.net)
    1060 W. Mason Street
    Green Bay
    WI,54303
    US
...
Administrative Contact:
    NetNet Inc.
    Jamie Vandenhoy        (netnetdns@netnet.net)
    PO Box 19079
    Green Bay
    Wisconsin,54307
    US
