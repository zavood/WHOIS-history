...
for detailed information.
   ...
   Domain Name: ROUTERGATE.COM
   Registrar: DIRECTI INTERNET SOLUTIONS PVT. LTD. D/B/A PUBLICDOMAINREGISTRY.COM
   Whois Server: whois.PublicDomainRegistry.com
   Referral URL: http://www.PublicDomainRegistry.com
   Name Server: NS1.ROUTERGATE.COM
   Name Server: NS2.ROUTERGATE.COM
   Name Server: NS3.ROUTERGATE.COM
   Status: ok
...
Registrars.
Registration Service Provided By: TRSERVER
Contact: +90.2244441346

Domain Name: ROUTERGATE.COM

Registrant:
    Bilisim yayincilik San.ve Tic.Ltd.Sti.
    DGN Teknoloji        (bilgi@dgn.net.tr)
    Demirtas Nahiye
    Cumhuriyet 240 Sok
    Bursa
    Bursa,16250
