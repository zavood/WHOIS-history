...
for detailed information.
   ...
   Domain Name: USERGUIDEMANUAL.COM
   Registrar: PT ARDH GLOBAL INDONESIA
   Whois Server: whois.resellerid.com
   Referral URL: http://www.resellerid.com
   Name Server: DNS1.HAQIQIE-VDS.QWORDS.NET
   Name Server: DNS2.HAQIQIE-VDS.QWORDS.NET
...
Domain servers in listed order:
    dns1.haqiqie-vds.qwords.net
    dns2.haqiqie-vds.qwords.net
