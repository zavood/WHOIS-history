...
for detailed information.
   ...
   Domain Name: BLACKMENHERE.COM
   Registrar: DOMAINLINK.CA INC.
   Whois Server: whois.domainlink.ca
   Referral URL: http://www.domainlink.ca
...
Registrars.
The results below are provided by domainlink.ca.
(whois.domainlink.ca)

By using domainlink.ca's WHOIS database, you confirm that you understand
the following, and you agree to be bound by the terms of usage and
limitations of warranty contained herein.

Although the data contained in domainlink.ca's WHOIS database is believed
by the company to be reliable, it is provided &quot;as is&quot;. domainlink.ca
...
information that may be included in the database. domainlink.ca's sole
...
written permission of domainlink.ca. By submitting a query to domainlink.ca,
...
Domain: blackmenhere.com

  Date Registered: 05/08/11
    Date Modified: 05/14/11
      Expiry Date: 05/08/12
      	     DNS1: ns1.above.com
      	     DNS2: ns2.above.com
  ...
  Technical Contact
        ...
        Registrar: domainlink.ca


Register your domain now at www.domainlink.ca
