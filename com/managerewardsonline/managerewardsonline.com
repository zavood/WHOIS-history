...
for detailed information.
   ...
   Domain Name: MANAGEREWARDSONLINE.COM
   Registrar: MARKMONITOR INC.
   Whois Server: whois.markmonitor.com
   Referral URL: http://www.markmonitor.com
   Name Server: NS1.BAC.COM
   Name Server: NS2.BAC.COM
   Name Server: NS3.BAC.COM
   Name Server: NS4.BAC.COM
   Name Server: NS5.BAC.COM
