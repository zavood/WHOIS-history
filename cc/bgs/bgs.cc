...
Go to http://registrar.verisign-grs.com/whois/ for detailed information.
   ...
   Name Server: NS0.BGS.CC
   Name Server: NS1.BGS.CC
   Name Server: DNS-AUTH-4.CENTURYLINKSERVICES.NET
   Name Server: DNS-AUTH-5.CENTURYLINKSERVICES.NET
...
Date and Time of Query: Fri Sep 16 23:06:59 EDT 2011
Reason Code: IE
