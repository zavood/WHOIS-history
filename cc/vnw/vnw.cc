...
Go to http://registrar.verisign-grs.com/whois/ for detailed information.
   ...
   Name Server: VNW.MERCURY.ORDERBOX-DNS.COM
   Name Server: VNW.VENUS.ORDERBOX-DNS.COM
   Name Server: VNW.EARTH.ORDERBOX-DNS.COM
   Name Server: VNW.MARS.ORDERBOX-DNS.COM
   Status: ACTIVE
...
Domain servers in listed order:
    vnw.earth.orderbox-dns.com
    vnw.mars.orderbox-dns.com
    vnw.mercury.orderbox-dns.com
    vnw.venus.orderbox-dns.com
